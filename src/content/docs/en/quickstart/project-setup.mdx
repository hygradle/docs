...
plugins { id("dev.hygradle.settings") version "0.0.3" }
...
Gradle currently has two supports methods of declaring Maven repositories for dependencies. You can either manage them per-project, or at [the settings level](https://docs.gradle.org/current/userguide/centralizing_repositories.html). Hygradle is unopinionated about which approach you use, and instead provides a repository handler extension you must call:
